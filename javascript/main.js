...
function startGame() {
  ...
  let bombIndexes = Array.from({ length: 10 }, () =>
      ...
      cell.addEventListener("click", () => {
        if (!bombIndexes.includes(currentIndex) && !gameOver) {
          if (!visited.includes(currentIndex)) {
            ...
            if (
              currentIndex % col !== 1 &&
              bombIndexes.includes(currentIndex - col - 1)
            ) {
              bombs++;
            }
            if (
              currentIndex > col &&
              bombIndexes.includes(currentIndex - col)
            ) {
              bombs++;
            }
            if (
            ...
            if (
              currentIndex % col !== 1 &&
              bombIndexes.includes(currentIndex - 1)
            ) {
              bombs++;
            }
            if (
